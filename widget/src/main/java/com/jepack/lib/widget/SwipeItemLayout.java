...
public class SwipeItemLayout extends ViewGroup {
    ...
    public void showTip(String msg){
        if(confirmView != null){
            confirmView.setText(msg);
            confirmView.setVisibility(View.VISIBLE);
            confirmView.bringToFront();
            bringChildToFront(confirmView);
            if(confirmView.getAnimation() == null){
                confirmView.setAnimation(AnimationUtils.loadAnimation(getContext(), R.anim.slide_r_t_l));
            }
        }
    }
    ...
    private boolean ensureChildren(){
        ...
        mMainView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                SwipeItemLayout.this.performClick();//点击此处表示点击整个Item
            }
        });
